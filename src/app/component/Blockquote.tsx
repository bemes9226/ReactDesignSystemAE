...
const Blockquote: React.FunctionComponent<IBlockquoteProps> = ({author,cite,content,style,quoto}) => {
  return (
    <blockquote className={`aegov-quote ${style ? style:""}`} cite="https://mohap.gov.ae/en/about-us/minister-message">
	{quoto && (<svg className="quote-icon" width="48" height="48" viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg">
